      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                frontend and backend technologies, from UI to APIs and databases.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>TOOLS</h3>
              <h4>Dev Tools & Practices</h4>
              <p>
                Comfortable with industry-standard tools for version control,
                API testing, and building RESTful services with clean,
                maintainable code.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
